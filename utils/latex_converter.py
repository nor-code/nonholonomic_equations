...
#
# print("\n\neq_3_subs_kinematic_restriction.txt")
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq3/d_d_x_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq3/d_d_y_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq3/d_d_α_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq3/d_d_φ_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq3/d_d_δ_t__2__.txt").readline())))
# print("free = ", print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq3/free_term.txt").readline())))
...
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq6/d_d_α_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq6/d_d_φ_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq6/d_d_δ_t__2__.txt").readline())))
...
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq9/d_d_α_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq9/d_d_φ_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq9/d_d_δ_t__2__.txt").readline())))
...
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq10/d_d_α_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq10/d_d_φ_t__2__.txt").readline())))
# print(print_in_latex(parse_2_sympy_expression(open("../collect_parallel/eq10/d_d_δ_t__2__.txt").readline())))
