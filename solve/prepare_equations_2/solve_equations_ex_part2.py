...
def system_eq(y, t):
    ...
    g = 10
    det = -1.91103931978889e-9

    eq1 = (-5.23463184855e-11*g*x1 + 1.04544231341019e-9*g*x2 + 1.20361266985006e-9*g*x3 + 5.23463184855e-11*g*x6 + 1.1114673695775e-10*g) / det # x
    eq2 = (5.23463184855e-11*g*x1 - 1.20510943725905e-9*g*x2 - 1.04693908081917e-9*g*x3 - 5.23463184855e-11*g*x6 + 1.1114673695775e-10*g) / det # y
    eq3 = (2.6864924849685e-8*g*x1 - 1.91485957011131e-8*g*x2 - 1.91222992176694e-8*g*x3 - 2.6864924849685e-8*g*x6 + 1.84786099875e-11*g) / det# α
