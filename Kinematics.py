...
# скорость центра масс колеса, т.е. скорость т. B в проекции на оси, связанные с платформой
# т.е. в с.к. С_x1_x2_x3
# нужно использовать угловую скрость колеса, но т.к. центр масс колеса всегда совпаает с геометрическим центром
# то используем угловую скорость платформы
V_B = V_O + P_x_X * Matrix([[p_p], [q_p], [r_p]]).cross(R_cm_w)
