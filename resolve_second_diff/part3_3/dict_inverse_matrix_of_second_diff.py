...
inverse_coeff_matrix = {
    ...
    m15: parse_2_sympy_expression(open("../part2_3/component_m14.txt").readline()),
    ...
    m25: parse_2_sympy_expression(open("../part2_3/component_m14.txt").readline()),
    ...
    m35: parse_2_sympy_expression(open("../part2_3/component_m14.txt").readline()),
    ...
    m45: parse_2_sympy_expression(open("../part2_3/component_m14.txt").readline()),
}
t2 = time.time()
