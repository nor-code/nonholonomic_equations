...
mixed_coeff_var = {
    ...
    c_1: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_x_t__d_β_t_.txt").readline()).coeff(diff(x, t) * diff(x1, t)),
    c_2: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_x_t__d_δ_t_.txt").readline()).coeff(diff(x, t) * diff(x6, t)),
    ...
    c_4: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_y_t__d_δ_t_.txt").readline()).coeff(diff(y, t) * diff(x6, t)),
    ...
    c_7: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_α_t__d_δ_t_.txt").readline()).coeff(diff(x1, t) * diff(x6, t)),
    c_8: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_β_t__d_δ_t_.txt").readline()).coeff(diff(x2, t) * diff(x6, t)),
    c_9: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_δ_2.txt").readline()).coeff(diff(x6, t) ** 2),
...
dict_free_term_equations = {
    ...
    free_3: parse_2_sympy_expression(open("../../collect_parallel/eq7/free_term.txt").readline()),
