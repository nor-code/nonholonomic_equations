...
main_vars_subs = {
    ...
    a5: parse_2_sympy_expression(open(
        "../../collect_parallel/eq3/d_d_ψ_t__2__.txt").readline()).coeff(diff(diff(x5, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    ...
    b5: parse_2_sympy_expression(open(
        "../../collect_parallel/eq6/d_d_ψ_t__2__.txt").readline()).coeff(diff(diff(x5, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),

    c1: parse_2_sympy_expression(open(
         "../../collect_parallel/eq7/d_d_x_t__2__.txt").readline()).coeff(diff(diff(x, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    c2: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_d_y_t__2__.txt").readline()).coeff(diff(diff(y, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    c3: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_d_α_t__2__.txt").readline()).coeff(diff(diff(x1, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    c4: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_d_φ_t__2__.txt").readline()).coeff(diff(diff(x4, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    c5: parse_2_sympy_expression(open(
        "../../collect_parallel/eq7/d_d_ψ_t__2__.txt").readline()).coeff(diff(diff(x5, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    ...
    d5: parse_2_sympy_expression(open(
        "../../collect_parallel/eq9/d_d_ψ_t__2__.txt").readline()).coeff(diff(diff(x5, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
    ...
    e5: parse_2_sympy_expression(open(
        "../../collect_parallel/eq10/d_d_ψ_t__2__.txt").readline()).coeff(diff(diff(x5, t), t)).subs(inertia).subs(dict_for_subs, simultaneous=True),
}
