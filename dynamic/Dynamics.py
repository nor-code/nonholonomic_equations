...
Q_α = diff(U_w, x1) + diff(U_p, x1) - M_ψ
Q_β = diff(U_w, x2) + diff(U_p, x2) - M_φ * sin(x5)
Q_γ = diff(U_w, x3) + diff(U_p, x3) - M_φ * cos(x5)
Q_φ = M_φ  # M_φ  # P_x_X * Matrix([[M_φ * cos(x5)], [M_φ * sin(x5)], [0]])
